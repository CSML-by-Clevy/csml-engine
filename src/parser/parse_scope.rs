...
use crate::parser::{
    ast::*, parse_actions::{parse_root_functions, parse_hook}, parse_comments::comment,
    parse_for_loop::parse_foreach, parse_if::parse_if, tokens::*, tools::*,
};
use nom::{
...
pub fn parse_root_scope<'a, E: ParseError<Span<'a>>>(s: Span<'a>, name: String) -> IResult<Span<'a>, (Block, FlowType), E> {
    delimited2(
        preceded(comment, tag(L_BRACE)),
        parse_root,
        preceded(comment, parse_r_brace),
...
// TODO: TMP
pub fn delimited2<I, O1, O2, O3, E: ParseError<I>, F, G, H>(first: F, sep: G, second: H, name: String) -> impl Fn(I) -> IResult<I, O2, E>
where
