...
fn search_ident_in_obj(map: &HashMap<String, Literal>, ident: &Identifier, data: &mut Data) -> Result<Literal, ErrorInfo> {
...
pub fn decompose_object(literal: &Literal, expr: &Expr, interval: &Interval, data: &mut Data) -> Result<Literal, ErrorInfo> {
