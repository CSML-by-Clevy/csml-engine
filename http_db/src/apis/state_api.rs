...
impl StateApiClient {
    pub fn new(configuration: Rc<configuration::Configuration>) -> StateApiClient {
        StateApiClient { configuration }
    }
}

pub trait StateApi {
    fn delete_state_full(&self, bot_id: &str, user_id: &str, channel_id: &str)
        -> Result<(), Error>;
    fn delete_state_key(
        &self,
        _type: &str,
    ...
    fn get_state_full(
        ...
        user_id: &str,
        channel_id: &str,
    ) -> Result<Vec<crate::models::StateModel>, Error>;
    fn get_state_key(
        &self,
        _type: &str,
        key: &str,
        ...
        user_id: &str,
        channel_id: &str,
    ) -> Result<crate::models::StateModel, Error>;
    fn get_state_type(
        &self,
        _type: &str,
        bot_id: &str,
    ...
    fn set_state_items(
        ...
        user_id: &str,
        channel_id: &str,
        create_state_body: Vec<crate::models::CreateStateBody>,
    ) -> Result<(), Error>;
}

impl StateApi for StateApiClient {
    fn delete_state_full(
        &self,
        bot_id: &str,
        user_id: &str,
        channel_id: &str,
    ...
    fn delete_state_type(
        ...
        let uri_str =
            format!("{}/state/{type}", configuration.base_path, type=crate::apis::urlencode(_type));
        let mut req_builder = client.delete(uri_str.as_str());
